...
#######################################################################
# Copyright(c) 2007-2011 Whitehead Institute for Biomedical Research.
#              All Rights Reserved
#
# Author: George Bell
...
use strict;	# Added in version 5.2
...
sub findRemoveMatchSubsets
{
	...
	# ex: 8mer-1 includes 7mer-m8 and 7mer-1a matches
